...
const SettingsRow = ({ title, description, right, onPress }: SettingsRowProps) => {
  return (
    <TouchableOpacity 
...
const SettingsScreen = () => {
  ...
  const showBackupInfo = () => {
    Alert.alert(
      ...
      [
        { text: 'Sauvegarder maintenant', onPress: () => console.log('Backup requested') },
  ...
  const showSecurityInfo = () => {
    Alert.alert(
      ...
      [
        { text: 'Configurer', onPress: () => console.log('Security config requested') },
    ...
    <ScrollView style={styles.container}>
      ...
      <SettingsSection title="Aide">
        ...
        <SettingsRow 
          ...
          right={<Text style={styles.chevron}>›</Text>}
          onPress={() => Alert.alert('Support', 'Contact: support@axiomapp.com')}
        />
      </SettingsSection>
