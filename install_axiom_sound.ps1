# Installation du son Axiom Vibe pour Windows
...
Write-Host "Téléchargement et intégration du son pour Axiom Vibe..." -ForegroundColor Cyan
...
Write-Host "2. Entrez l'URL: https://youtu.be/fmn30d0vsuw" -ForegroundColor Yellow
Write-Host "3. Téléchargez le fichier audio en MP3" -ForegroundColor Yellow
Write-Host "4. Renommez-le en 'axiom_vibe.mp3'" -ForegroundColor Yellow
...
if ($confirmation -eq "O" -or $confirmation -eq "o") {
    ...
    if (Test-Path $sourceFile) {
        ...
        Copy-Item $sourceFile -Destination "android\app\src\main\res\raw\axiom_vibe.mp3" -Force
        
        Write-Host "Copie du fichier audio dans les ressources iOS..." -ForegroundColor Green
        Copy-Item $sourceFile -Destination "ios\AxiomApp\Resources\axiom_vibe.mp3" -Force
        
        Write-Host "Installation terminée! Le son Axiom Vibe est maintenant intégré dans l'application." -ForegroundColor Green
    }
    else {
